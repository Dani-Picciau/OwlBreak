...
\begin{document}
    ...
    \end{tcolorbox}
    \noindent
    La tabella \textit{Cliente} non presenta dipendenze parziali in quanto la chiave è composta da un solo attriburo, quindi la tabella è dicuramente in 2NF. Per verificare che sia anche in 3NF bisogna controllare che non ci siano dipendenze transitive o, in caso contrario, che gli attributi dipendenti siano parte della chiave. 
