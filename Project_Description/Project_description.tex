...
\begin{document}
    ...
    Una volta eseguita la connessione come admin, si cercano nelle tabelle le credenziali del singolo utente dell'applicazione, per poter memorizzare il tipo di utente.
