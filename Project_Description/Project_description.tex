...
\begin{document}
    ...
    public class Main {
        // Definisco le credenziali per la connessione al database fissata come admin.
        // Dunque si avranno tutti i privilegi possibili
        private static final String DB_URL = "jdbc:mysql://localhost:3306/Owlbreak";
        ...
        public static void main(String[] args) {
            ...
            try {
                // Connessione al DB con credenziali fisse
                conn = DriverManager.getConnection(DB_URL, DB_USER, DB_PASSWORD);
                System.out.println("Connessione al database stabilita!");
                System.out.println("----------------------------------");

                //Preparo le variabili per le query che andro' ad eseguire dopo
                String query;
                PreparedStatement preparedStatement;
                ResultSet resultSet;

                while(true){
                    // Richiedo le credenziali dell'utente dell'applicazione
                    System.out.print("Inserisci la tua email (\"exit\" per uscire): ");
                    String email_log = scanner.nextLine();
                    if(email_log.equalsIgnoreCase("exit")){
                        System.out.print("Chiusura del programma in corso\n");
                        break;
                    }
                    ...
                    // Verifico il login e determino il tipo di utente
                    String userType = authenticateUser(conn, email_log, password);

                    if (userType != null) {
                        System.out.print("Login effettuato con successo!\n");
                        System.out.print(" Tipo utente: " + userType +"\n");
                        System.out.print(" Email: " + email_log + "\n");
                        System.out.print("\n");
    ...
    \end{lstlisting}
    Nonostante non venga mostrato nell'estratto di cui sopra, una volta che il login è stato effettuato, tramite una semplice switch-case condition, si viene reinderizzati al menù corrispondente al tipo di utente loggato. Tramite i relativi menù è possibile scegliere quale operazione di visualizzazione eseguire e visualizzare di conseguenza le relative tuple di risultato.
