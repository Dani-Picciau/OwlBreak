...
<?php
    ?>
        ...
        <div class="success-message" id="successMessage-addUser">
            ...
            <span>Utente aggiunto con successo!</span>
        </div>

        <div class="error-message" id="errorMessage-addUser">
            <?php
                if (isset($_SESSION['input_not_filled_add_user'])) {
                    ?>
        ...
        <form class="password-form" id="addUserForm" method="POST" action="users_profile_includes/adding_user.php">
            ...
            <div class="form-actions">
                <button type="button" class="btn btn-secondary" id="reset-form-add-user">Annulla</button>
