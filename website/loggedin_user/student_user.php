...
<html lang="en">
    ...
    <body>
        ...
        <div class="content-box"  id="page-content">
            ...
            <div class="order-box">
                <div class="menu-box">
                    <div class="menu-category" data-category="Sandwiches">
                    ...
                    <div class="menu-category" data-category="Sweets">
                    ...
                    <div class="menu-category" data-category="Pizza & more">
                    ...
                    <div class="menu-category" data-category="Snack & more">
